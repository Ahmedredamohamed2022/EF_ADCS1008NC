...
C {tg_lsx.sym} 210 -390 0 0 {name=x2}
C {tg_lsx.sym} 200 -260 0 0 {name=x3}
...
C {sky130_stdcells/inv_2.sym} -35 -140 0 0 {name=x11 VGND=vss VNB=vss VPB=vdd1p8 VPWR=vdd1p8 prefix=sky130_fd_sc_hvl__ 
}
